...
func (a *App) TypeExporter(calibrationPoint CalibrationPoint, calibratedCalibrationPoint CalibratedCalibrationPoint, fixture Fixture, sacnConfig SACNConfig, dmxData DMXData, point Point, triangle Triangle) {
